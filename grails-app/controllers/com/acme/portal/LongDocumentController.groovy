...
/**
 * Large document controller. Real path traversal below line 400.
 *
 * SYNTHETIC benchmark fixture — not customer code. British English throughout.
 */
class LongDocumentController {
    static final String ROOT = '/var/app/docs'
    ...
    def fetch() {
        def doc = params.doc
        def file = new File(ROOT + '/' + doc)
        render file: file.bytes, fileName: doc
    }
