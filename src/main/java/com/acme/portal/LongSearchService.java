...
/**
 * Large directory service. Real LDAP injection below line 400.
 *
 * SYNTHETIC benchmark fixture — not customer code. British English throughout.
 */
public class LongSearchService {
    ...
    public NamingEnumeration<SearchResult> byCn(String cn) throws NamingException {
        String filter = "(cn=" + cn + ")";
